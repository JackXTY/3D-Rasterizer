...
private slots:
    ...
    void on_action_AA1x_triggered();

    void on_action_AA4x_triggered();

    void on_action_AA9x_triggered();

    void on_action_AA16x_triggered();

    void on_action_Solid_Face_triggered();
