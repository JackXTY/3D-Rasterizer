...
void MainWindow::keyPressEvent(QKeyEvent *e)
{
    ...
    case Qt::Key_W : rasterizer.cam.TranslateForward(0.5f); break;
    case Qt::Key_S : rasterizer.cam.TranslateForward(-0.5f); break;
    case Qt::Key_A : rasterizer.cam.TranslateRight(-0.5f); break;
    case Qt::Key_D : rasterizer.cam.TranslateRight(0.5f); break;
    case Qt::Key_Q : rasterizer.cam.TranslateUp(-0.5f); break;
    case Qt::Key_E : rasterizer.cam.TranslateUp(0.5f); break;
    case Qt::Key_Up : rasterizer.cam.RotateAboutRight(-5.f); break;
    case Qt::Key_Down : rasterizer.cam.RotateAboutRight(5.f); break;
    case Qt::Key_Left : rasterizer.cam.RotateAboutUp(5.f); break;
    case Qt::Key_Right : rasterizer.cam.RotateAboutUp(-5.f); break;
    case Qt::Key_Z : rasterizer.cam.RotateAboutForward(5.f); break;
    case Qt::Key_X : rasterizer.cam.RotateAboutForward(-5.f); break;
    }
...
void MainWindow::on_action_AA1x_triggered()
{
    rasterizer.AAratio = 1;
    rendered_image = rasterizer.RenderScene();
    DisplayQImage(rendered_image);
}

void MainWindow::on_action_AA4x_triggered()
{
    rasterizer.AAratio = 2;
    rendered_image = rasterizer.RenderScene();
    DisplayQImage(rendered_image);
}

void MainWindow::on_action_AA9x_triggered()
{
    rasterizer.AAratio = 3;
    rendered_image = rasterizer.RenderScene();
    DisplayQImage(rendered_image);
}

void MainWindow::on_action_AA16x_triggered()
{
    rasterizer.AAratio = 4;
    rendered_image = rasterizer.RenderScene();
    DisplayQImage(rendered_image);
}

void MainWindow::on_action_Solid_Face_triggered()
{
    rasterizer.renderWireframe = false;
    rendered_image = rasterizer.RenderScene();
    DisplayQImage(rendered_image);
}
...
{
    rasterizer.renderWireframe = true;
    rendered_image = rasterizer.RenderScene();
    DisplayQImage(rendered_image);
}
